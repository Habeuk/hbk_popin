...
/* harmony default export */ const whatsappMessage = (whatsappMessage);
...
(function (Drupal) {
  Drupal.behaviors.myModuleBehavior = {
    attach: function (context, settings) {
      if (once("hbkPopup", ".whatsapp-widget", context).length > 0) {
        const HBK = new whatsappMessage(context);
        HBK.build();
      }
    }
  };
